...
# 輸入資料夾和輸出資料夾
input_folder = '/home/cluster/factory_project/data/Silk_scraps'
output_folder = '/home/cluster/factory_project/crop_data/Silk_scraps'
...
for image_file in image_files:
    ...
    # 建立視窗，顯示圖片，使用者可以在圖片上選擇區域
    cv2.imshow("Select Region", img)
    rect_box = cv2.selectROI("Select Region", img, fromCenter=False, showCrosshair=True)

    # 關閉視窗
    cv2.destroyAllWindows()

    # 取得bounding box座標
    x, y, width, height = rect_box
